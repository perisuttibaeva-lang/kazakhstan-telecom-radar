...
$Sources = @(
  ...
  @{ name = "Транстелеком"; type = "Google News RSS"; query = 'Транстелеком Казахстан OR Transtelecom Kazakhstan OR TTC Казахстан тариф OR интернет OR связь OR 5G' },
...
$Operators = @(
  ...
  @{ name = "Транстелеком"; tokens = @("транстелеком", "transtelecom", "ttc", "ттк") },
...
$RelevantTokens = @("beeline", "билайн", "kcell", "кселл", "activ", "актив", "tele2", "теле2", "altel", "алтел", "казахтелеком", "kazakhtelecom", "транстелеком", "transtelecom", "ttc", "ттк", "связ", "сотов", "телеком", "оператор", "тариф", "абонент", "мобильный интернет", "5g", "4g", "базов", "провайдер")
